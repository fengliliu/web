...
<%
	...
	if isnumeric(id) and id<>"" then
		...
		sql = "select MovieAddr,readme from movie where id="&id
		rs.open sql,conn,1,1
		if not rs.eof then
			MovieAddr = rs("MovieAddr")
			readme = rs("readme")			
		end if
		rs.close
		set rs=nothing
...
<div class="content"> 
  ...
  <div class="cont_you">
    ...
    <div class="you_nr">
      ...
      <dl class="xinxi">
        <dt>
        <embed src="<%=MovieAddr%>" quality="high" width="600" height="400" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash"></embed>
