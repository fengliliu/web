...
Const BannerUrl="/images/banner.jpg"        'Banner地址
Const IsFlash="No"        '是否为FLASH
Const width=""        '宽度
Const height=""        '高度
Const WebmasterName="hyf"        '站长姓名
Const WebmasterEmail="371029951@qq.com"        '站长信箱
Const ComPic_count="20"        '首页形象图数
Const New_count=20        '首面新闻资讯条数
Const MaxPerPage=15        '文章搜索页每页文章数
Const EnableProductCheck=""        '是否启用文章审核功能
Const EnableUploadFile="Yes"        '是否开放文件上传
Const MaxFileSize=1024        '上传文件大小限制
Const SaveUpFilesPath="UploadFiles"        '存放上传文件的目录
Const UpFileType="gif|jpg|bmp|png|swf|doc|rar|mpg"        '允许的上传文件类型
