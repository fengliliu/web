...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"> <br> <br>
      <strong>广 告 类 别 设 置</strong> <br> <br> <br> 
      <table width="500" border="0" cellpadding="0" cellspacing="1" bgcolor="#000000" class="border">
        ...
        <tr bgcolor="A4B6D7" class="title"> 
          ...
          <td width="251" height="20" align="center"><a href="MovieClassAddBig.asp">添加广告大类</a></td>
        </tr>
        <%
...
%>
        <tr bgcolor="ECF5FF" class="tdbg"> 
          ...
          <td align="center"><a href="MovieClassAddSmall.asp?BigClassName=<%=rsBigClass("BigClassName")%>">添加子栏目</a> 
            | <a href="MovieClassModifyBig.asp?BigClassID=<%=rsBigClass("BigClassID")%>">修改</a> 
            | <a href="MovieClassDelBig.asp?BigClassName=<%=rsBigClass("BigClassName")%>" onClick="return ConfirmDelBig();">删除</a></td>
        </tr>
        <%
	...
	%>
        <tr bgcolor="#E3E3E3" class="tdbg"> 
          ...
          <td align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            <a href="MovieClassModifySmall.asp?SmallClassID=<%=rsSmallClass("SmallClassID")%>">修改</a> 
            | <a href="MovieClassDelSmall.asp?SmallClassID=<%=rsSmallClass("SmallClassID")%>" onClick="return ConfirmDelSmall();">删除</a></td>
        </tr>
        <%
