...
DefaultPicUrl=server.htmlencode(Trim(Request("DefaultPicUrl")))
...
sql="select * from Movie where id is null "
            ...
            <td><div align="center"> 
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                  ...
                  <tr bgcolor="#ECF5FF"> 
                    ...
                    <td> 
                    	<input name="DefaultPicUrl" type="text"  size="40" maxlength="50"><br>
