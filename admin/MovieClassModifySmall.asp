...
if SmallClassID="" then
	response.Redirect("MovieClassManage.asp")
end if
Set rs=Server.CreateObject("Adodb.RecordSet")
rs.Open "Select * from SmallClass_Movie where SmallClassID="&SmallClassID&"",conn,1,3
	...
	if Action="Modify" then
		...
		if FoundErr<>True then
			...
			if SmallClassName<>OldSmallClassName then
				conn.execute "Update Movie set SmallClassName='" & SmallClassName & "' where BigClassName='" & BigClassName & "' and SmallClassName='" & OldSmallClassName & "'"
	     	end if
			call CloseConn()
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"> <br> <br>
      <strong>视 频 类 别 设 置</strong> <br> <br> <br> <form name="form1" method="post" action="MovieClassModifySmall.asp">
        <p>&nbsp;</p>
