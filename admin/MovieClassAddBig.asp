...
if Action="Add" then
	...
	if FoundErr<>True then
		...
		rs.open "Select * From BigClass_Movie Where BigClassName='" & BigClassName & "'",conn,1,3
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"> <br> <br>
      <strong>视 频 类 别 设 置</strong> <br> <br> <br>
      <form name="form1" method="post" action="MovieClassAddBig.asp" onsubmit="return checkBig()">
