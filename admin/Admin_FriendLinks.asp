...
<form method="post" name="myform" onSubmit="return Check()" action="Admin_FriendLinks.asp">
  <table width="90%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" class="border">
    ...
    <tr bgcolor="#FFFFFF" class="tdbg"> 
      ...
      <td height="25"> 
        <input name="DefaultPicUrl" size="30"  maxlength="100" type="text"  value="http://" title="这里请输入您的网站LogoUrl地址，最多为50个字符，如果您在第一选项选择的是文字链接，这项就不必填">             <br> <iframe src="../upload_photo.asp?PhotoUrlID=6" frameborder="0" scrolling="no" height="25px"></iframe>
      </td>
    </tr>
    <tr bgcolor="#FFFFFF" class="tdbg"> 
...
<form method="post" name="myform" onSubmit="return Check()" action="Admin_FriendLinks.asp">
  <table width="90%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" class="border">
    ...
    <tr bgcolor="#FFFFFF" class="tdbg"> 
      <td width="300" height="25"><strong>网站Logo：</strong></td>
      <td height="25"> 
        <input name="DefaultPicUrl" size="30"  maxlength="100" type="text"  value="<%=rsLink("LogoUrl")%>" title="这里请输入您的网站LogoUrl地址，最多为50个字符，如果您在第一选项选择的是文字链接，这项就不必填">  <br> <iframe src="../upload_photo.asp?PhotoUrlID=6" frameborder="0" scrolling="no" height="25px"></iframe>
      </td>
    </tr>
    <tr bgcolor="#FFFFFF" class="tdbg"> 
      <td width="300" height="25"><strong>站长姓名：</strong></td>
