...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="862" align="center" valign="top"> <br> <p align="center"><strong>信 
        息 管 理</strong></p>
...
%>
      ...
      <form name="del" method="Post" action="News_Del.asp" onSubmit="return ConfirmDel();">
        <table width="620" border="0" cellpadding="0" cellspacing="1" bgcolor="#000000">
          <tr bgcolor="#A4B6D7"> 
            <td height="25"><a href="News_Manage.asp">&nbsp;信息管理</a> &gt;&gt; 
              <%
...
%>
        <table width="620" border="0" cellpadding="0" cellspacing="1" bgcolor="#000000" class="border" style="word-break:break-all">
          <tr bgcolor="#A4B6D7" class="title"> 
            ...
            <td width="246" align="center" bgcolor="#A4B6D7" >信息标题</td>
      ...
      <br> <table width="620" border="0" cellpadding="0" cellspacing="0" class="border">
        <tr class="tdbg"> 
          <form name="searchsoft" method="get" action="News_Manage.asp">
            <td height="30"> <strong>查找信息：</strong> <input name="Title" type="text" class=smallInput id="Title3" size="20" maxlength="50"> 
              <input name="Query" type="submit" id="Query" value="查 询"> &nbsp;&nbsp;请输入信息名称。如果为空，则查找所有信息。</td>
          </form>
        </tr>
      </table></td>
  </tr>
