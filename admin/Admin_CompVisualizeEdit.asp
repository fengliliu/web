...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"> <br> <table width="560" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
        <tr> 
          <td class="back_southidc" height="25"> <div align="center"><strong>修改广告<br>
              </strong></div></td>
        </tr>
        <tr> 
          <form method="post" name="myform" action="Admin_CompVisualizeEdit.asp?mark=southidc">
            ...
            <td><div align="center"> 
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr bgcolor="#ECF5FF"> 
                    <td height="22"> <div align="center">排序ID</div></td>
                    <td> <input name="OrderID" type="text" value="<%=rs("OrderID")%>" size="10" maxlength="10"> 
                      </td>
                  </tr>
                  <tr bgcolor="#ECF5FF"> 
                    <td width="24%" height="25"> <div align="center">广告说明</div></td>
                    <td width="76%"> <textarea name="Explain" cols="40" rows="8"><%=rs("Explain")%></textarea></td>
                  </tr>
                  <tr bgcolor="#ECF5FF"> 
                    <td height="22"> <div align="center">广告图片</div></td>
