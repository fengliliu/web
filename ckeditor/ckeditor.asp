...
'			set mergedConfig.Item("on") = configOn
	...
	private function ckeditorPath()
		...
		if not(exists) then
			...
			response.write "<p>The path &quot;<font color=red>" & ckeditorPath & "</font>&quot; doesn't include the CKEditor main file (" & ckeditorFileName() & ")</p>"
			response.write "<p>Please, verify that you have set it correctly and/or adjust the 'basePath' property</p>"
			response.write "<p>Checked for physical file: &quot;<font color=blue>" & filename & "</font>&quot;</p>"
			response.end
